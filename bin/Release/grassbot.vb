...
Module GRASSBOT
    ...
    Function RunWildcat()
        ...
        Call objRhinoScript.Command("-ViewCapturetoFile c:\wildcat_screenshot.png Width=2000 Height=2000 DrawGrid=No DrawWorldAxes=No DrawCPlaneAxes=No _Enter")
    ...
    Function PrintUsage()
        ...
        Console.WriteLine("Usage: GRASSBOT.exe /rhfile rhino-file /ghfile grasshopper-file [/bakename] [/tempdir] [/bake] [/application]" & vbNewLine & _
                          ...
                          "/application (true/false)    If Grassbot should load Rhino as Application or Interface." & vbNewLine)
